...
public partial class SubStoryAdminMaster : System.Web.UI.MasterPage
{
    ...
    public void IterationAdminviewMember(object sender, EventArgs e)
    {
        ...
        Response.Redirect("SubStoryAdminMemberData.aspx");
    }
    ...
    public void viewSubStory(object sender, EventArgs e)
    {
        ...
        Response.Redirect("SubStoryAdminSubStoryData.aspx");
    }
    ...
    public void viewTask(object sender, EventArgs e)
    {
        ...
        Response.Redirect("SubStoryAdminTaskData.aspx");
    }
}
