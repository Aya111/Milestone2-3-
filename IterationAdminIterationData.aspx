<%@ Page Title="" Language="C#" MasterPageFile="~/IterationAdminMaster.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="IterationAdminIterationData.aspx.cs" Inherits="IterationAdminIterationData" %>
...
Iter.ID =st_iter.IterationID and st.ID = st_iter.StoryID  and st.ProjectID=@id">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                         <asp:Button ID="Button1" runat="server" Text="Edit Iteration"   class="btn btn-primary" style="display: inline-block;padding: 2px 8px;" OnCommand="GO_Edit" />
