...
public partial class TaskAdminMaster : System.Web.UI.MasterPage
{
    ...
    public void IterationAdminviewMember(object sender, EventArgs e)
    {
        ...
        Response.Redirect("TaskAdminMemberData.aspx");
    }
    public void SubStoryAdminviewStory(object sender, EventArgs e)
    {
        Button Repeaterbtn = sender as Button;
        Session["StoryID"] = Repeaterbtn.CommandArgument;

        Response.Redirect("SubStoryAdminStoryData.aspx");
    }
    public void TaskAdminviewSubStory(object sender, EventArgs e)
    {
        Button Repeaterbtn = sender as Button;
        Session["SubStoryID"] = Repeaterbtn.CommandArgument;

        Response.Redirect("TaskAdminSubStoryData.aspx");
    }
    public void StoryAdminviewIteration(object sender, EventArgs e)
    {
        ...
        Response.Redirect("TaskAdminIterationData.aspx");
    }
    public void viewTask(object sender, EventArgs e)
    {
        ...
        Response.Redirect("TaskAdminTaskData.aspx");
    }
